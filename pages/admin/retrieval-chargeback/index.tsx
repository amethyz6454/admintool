...
const RetrievalChargeBack: NextPage = (): JSX.Element => {
        ...
        >
            <Card.CardContainer variant="table">
                <Card.Header enableGrid gap={16} className="text-xs">
                    ...
                    <GridCol grid="auto">
                        Chargeback Status: <strong>Chargeback</strong>
                    </GridCol>
                    <GridCol grid="auto">
                    ...
                    <TableContainer>
                        <TableHead>
                            <TableRow>
                                ...
                                <TableCell>Chargeback Status</TableCell>
            ...
            <Modal title="Filter" size="sm" onClose={() => setShowFilterModal(false)} show={showFilterModal}>
                <ModalBody enableGrid>
                    <SelectField
                        id="retrievalChargeBack_status"
                        name="retrievalChargeBack_status"
                        label="Retrieval/CB Status"
                    >
            ...
            <Docker items={retrievalChargeBackTabs} />
        </Authenticated>
    );
};

export default RetrievalChargeBack;
